                        ...
                        <View style={styles.modalcontent}>
                            <View style={{borderBottomWidth:1,borderBottomColor:'#dfdfdf',paddingBottom:'2%'}}>
                                <View style={{flexDirection:'row', justifyContent:'space-between',paddingVertical:'1%'}}>
                                    <View>
                                        <Text style={styles.text1}>Claim Type</Text>
                                        <Text style={styles.text2}>Travel</Text>
                                    </View>
                                    <View>
                                        <Text style={styles.text1}>Advance</Text>
                                        <Text style={styles.text2}>200 USD</Text>
                                    </View>
                                    <View>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.text2}>Claim For Brisbane Tour</Text>
                                </View>
                            </View>
